...
helm.sh/chart: {{ include "sync-test.chart" . }}
...
*/}}
{{- define "sync-test.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "sync-test.fullname" .) .Values.serviceAccount.name }}
{{- else }}
